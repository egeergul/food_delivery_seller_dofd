...
class AppColors{
  ...
  static final Color mainColor = const Color(0XFF7851A9);
  static final Color mainColorTransparent = const Color(0X557851A9);
  static final Color mainBackgroundColor = const Color(0XFFEFE6F6);
