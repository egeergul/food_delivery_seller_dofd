...
class _OrderDetailState extends State<OrderDetail> {
  ...
  _OrderDetailState(this.pageId,
      this.page,);

  @override
  Widget build(BuildContext context) {
    var product = Get
        .find<AllOrdersController>()
        .allOrdersList[pageId];
                          ...
                          children: [
                            ...
                            BigText(
                              ...
                              ['contact_person_number'] ==
                                  null
                                  ? "Phone unknown"
                                  : "PHONE NO: " + product['delivery_address']
                              ['contact_person_number']
                                  .toString(),
                            ),
                            SizedBox(height: Dimensions.height10),
                                                ...
                                                child: Container(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          BigText(
                                                            text: "PRODUCT: " + jsonDecode(orderDetailController
                                                          ...
                                                          SmallText(
                                                            text: "Cost: \$" +
                                                                orderDetailController
                                                                    .orderDetailsList[index]
                                                                    .price!
                                                                    .toString() + " X " +orderDetailController
                                                                  .orderDetailsList[index]
                                                                  .quantity!
                                                                  .toString() + " = \$" + (orderDetailController
                                                                .orderDetailsList[index]
                                                                .price! * orderDetailController
                                                                .orderDetailsList[index]
                                                                .quantity!).toString()
                                                          ),
                                                          SizedBox(
